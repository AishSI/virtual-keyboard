const KEYS = [
  [ // RU - no Caps, no Shift: 000 => 0
    ...
    'Control', 'Lang', 'Alt', ' ', 'AltGraph', 'ArrowLeft', 'ArrowDown', 'ArrowRight', 'Control',
  ],
  ...
  [ // EN - no Caps, no Shcift: 100 => 4
    ...
    'Control', 'Lang', 'Alt', ' ', 'Alt', 'ArrowLeft', 'ArrowDown', 'ArrowRight', 'Control',
  ],
  ...
  [
    ...
    'ControlLeft', 'Lang', 'AltLeft', 'AltRight', 'ControlRight',
  ],
];
